...
SECTIONS = (
    HistorySection(
        ...
        date_column="BQ",
        invested_column="BR",
        monthly_contribution_column="BS",
        value_column="BT",
        profit_column="BU",
        return_rate_column="BV",
        monthly_result_column="BW",
    ),
    HistorySection(
        name="P2P",
        ...
        date_column="BY",
        invested_column="BZ",
        monthly_contribution_column="CA",
        value_column="CB",
        profit_column="CC",
        return_rate_column="CD",
        monthly_result_column="CE",
    ),
    HistorySection(
        ...
        date_column="CG",
        invested_column="CH",
        monthly_contribution_column="CI",
        value_column="CJ",
        profit_column="CK",
        return_rate_column="CL",
        monthly_result_column="CM",
    ),
)
